...
class Tornado:
    ...
    def create_tornado(self):
        ...
        utility.parent_objects(alas, [tihang_utama], name='tornado')
        tornado = utility.get_object_by_name('tornado')
        tornado.location = self.location


    def animate_tornado(self):
...
def main():
    utility.clear_mesh()
    tornado = Tornado(location=(10,0,0))
    # tornado.animate_tornado()
